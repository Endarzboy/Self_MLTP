...
class SpatioTemporalConv(nn.Module):
    ...
    Args:
        ...
        padding (int or tuple, optional): Zero-padding added to the sides of the input during their
...
class SpatioTemporalResLayer(nn.Module):
    ...
    blocks of same output size stacked on top of each other
        ...
        Default: SpatioTemporalResBlock.
            downsample (bool, optional): If ``True``, the first block in layer will implement downsampling.
        Default: ``False``
        """
...
#     r21d = R2Plus1DNet((2, 2, 2, 2), num_classes=3).cuda()
#     input_ = torch.randn((4, 1, 8, 112, 112)).cuda()
#     out = r21d(input_)
#     print(out.size())
#     summary(r21d, (1, 8, 112, 112))
